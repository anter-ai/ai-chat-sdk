...
export declare function registerArtifact(type: string, config: ArtifactRendererConfig): void;
export declare function getArtifactRegistry(): Map<string, ArtifactRendererConfig>;
