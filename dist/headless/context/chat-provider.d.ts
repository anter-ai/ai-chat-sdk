...
export declare function ChatProvider({ children, adapter, organizationId, config, strings, plugins, onSlashCommand, className, style, ...rest }: ChatProviderProps): import("react/jsx-runtime").JSX.Element;
