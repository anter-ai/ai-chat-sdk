...
export interface ChatAdapter {
    ...
    sendMessage(payload: MessagePayload, options?: SendMessageOptions): Promise<ReadableStream<Uint8Array>>;
    loadSlashCommands?(): Promise<void>;
    uploadFile?(sessionId: string, file: File, options?: UploadFileOptions): Promise<ChatSessionFileRef>;
    ...
    getExecutionStream?(executionId: string, resumeFrom?: number, options?: SendMessageOptions): Promise<ReadableStream<Uint8Array>>;
    /**
     ...
     */
    resumeExecution?(executionId: string, options?: SendMessageOptions): Promise<ReadableStream<Uint8Array>>;
}
